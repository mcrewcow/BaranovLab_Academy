...
data_dir <- 'C://Bioinf/BNV-LAB/Amf2'
list.files(data_dir)
...
D59fetalS <- ProcessSeu(D59fetalS)
D59fetalS$origin <- 'Petr Baranov & Milica Margeta Lab'
D59fetalS$condition <- 'host	Cx3cr1_ GFP +ve'
D59fetalS$tissue <-  'Retina'
D59fetalS$donor <- 'Amf2'
SaveH5Seurat(D59fetalS, 'C://Bioinf/Amf2.h5Seurat', overwrite = TRUE)
saveRDS(D59fetalS, 'C://Bioinf/Amf2.rds')
